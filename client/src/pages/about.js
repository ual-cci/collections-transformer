      ...
      <main>
        <div className="container">
            ...
            <ul>
              ...
              <li><strong>What is a workspace?</strong> A workspace is the user's database of models and datasets that are uploaded by users. Please refer to the <a href="/ecosystem" style={{ textDecoration: 'underline', color: '#000000' }}>Ecosystem</a> page for more information.</li>
