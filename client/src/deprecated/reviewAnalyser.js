    ...
    return (
        ...
        <div className="container review-page">
            ...
            {(analyser_owner == user_id) ? (
              ...
              <br></br>
              {/* 
                Analyser Versions Section:
                This displays a list of all versions of the current analyser,
                allowing users to compare different iterations and their performance.
                Each version shows the accuracy achieved and allows switching between versions.
